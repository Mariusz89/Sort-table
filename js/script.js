...
document.addEventListener('DOMContentLoaded',() => {
  document.getElementById('sortByName').addEventListener('click', sortTable.bind(null,0));
  document.getElementById('sortByAge').addEventListener('click', sortTable.bind(null,1));
  document.getElementById('inputAge').addEventListener('keyup', minimumAge);
});
